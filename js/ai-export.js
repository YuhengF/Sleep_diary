...
const LEGEND = {
  ...
  fields: {
    ...
    showerAfterWake: 'true/false — showered after waking',
    morningReward: 'free text — a fun/rewarding thing done in the morning',
...
function cleanEntry(e, shift, includeNotes) {
  const out = {
    ...
    coldFaceWash: e.coldFaceWash ?? null, showerAfterWake: e.showerAfterWake ?? null,
    morningReward: includeNotes ? (e.morningReward || null) : null,
